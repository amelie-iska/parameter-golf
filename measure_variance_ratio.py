...
def build_model(mod, device, model_type):
    ...
    extra_params = {
        ...
        'fineweb_graphify': getattr(args, 'fineweb_graphify', False),
        'tokengt_first_class': getattr(args, 'tokengt_first_class', False),
        'tokengt_graph_radius': getattr(args, 'tokengt_graph_radius', 4),
        'tokengt_token_class_buckets': getattr(args, 'tokengt_token_class_buckets', 64),
        'tokengt_position_buckets': getattr(args, 'tokengt_position_buckets', 256),
        'tokengt_structural_weight': getattr(args, 'tokengt_structural_weight', 0.05),
        'tokengt_edge_weight': getattr(args, 'tokengt_edge_weight', 0.035),
        'tokengt_torus_weight': getattr(args, 'tokengt_torus_weight', 0.015),
        'tokengt_identifier_dim': getattr(args, 'tokengt_identifier_dim', 24),
        'tokengt_identifier_weight': getattr(args, 'tokengt_identifier_weight', 0.014),
        'tokengt_endpoint_weight': getattr(args, 'tokengt_endpoint_weight', 0.018),
        'tokengt_edge_token_weight': getattr(args, 'tokengt_edge_token_weight', 0.016),
        'graph_output_flattening': getattr(args, 'graph_output_flattening', False),
        'graph_output_edge_radius': getattr(args, 'graph_output_edge_radius', 4),
        'graph_output_node_weight': getattr(args, 'graph_output_node_weight', 0.05),
        'graph_output_edge_weight': getattr(args, 'graph_output_edge_weight', 0.05),
        'graph_output_virtual_edge_tokens': getattr(args, 'graph_output_virtual_edge_tokens', True),
        'graph_output_edge_token_weight': getattr(args, 'graph_output_edge_token_weight', 0.035),
        'graph_output_score_correction': getattr(args, 'graph_output_score_correction', True),
        'graph_output_score_correction_weight': getattr(args, 'graph_output_score_correction_weight', 0.024),
    }
